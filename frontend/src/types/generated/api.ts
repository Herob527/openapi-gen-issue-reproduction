...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        indexPost: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/`;
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public indexPost(options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).indexPost(options).then((request) => request(this.axios, this.basePath));
    }
}
